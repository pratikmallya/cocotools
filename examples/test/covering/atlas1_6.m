classdef atlas1_6 < AtlasBase
  %ATLAS1_6  Can start on boundary of computational domain.
  ...
  methods (Access=private)
    function atlas = atlas1_6(prob, cont, dim)
  ...
  methods (Access=public)
    ...
    function [prob atlas cseg flush] = init_atlas(atlas, prob, cseg)
      ...
      % necessary fot t-dependent monitor functions

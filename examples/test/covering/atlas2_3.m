classdef atlas2_3 < AtlasBase
  %ATLAS2_3  Polyhedral boundary.
  %   Note: order of boundary merge changed with respect to previous versions!
  ...
  methods (Access=private)
    function atlas = atlas2_3(prob, cont, dim)

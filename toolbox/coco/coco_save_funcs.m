...
for i=1:nefuncs
  ...
  fid  = opts.efunc.funcs(i).identifyer; % for debugging only
...
for i=1:nsfuncs
  ...
  fid  = opts.slots.funcs(i).identifyer; % for debugging only
...
for i=1:nhfuncs
  ...
  fid  = opts.efunc.events(i).name{1}; % for debugging only
